...
from domain.services.analysis import update_pet_state
from domain.services.bowl import analyze_bowl, is_in_food_bowl
from domain.services.detection import parse_pet_detection
from domain.services.movement import is_moving_by_rate, movement_rate
from domain.services.scoring import (
...
from infrastructure.external_services.image_processor import compress_image
    ...
    async def execute(
        ...
        for frame in sampled_candidates:
            try:
                ...
                pet_result = self._ezviz.detect_pet_base64(image_base64)
